...
map.addControl(
 ...
 map.on("mousemove", (event) => {
  ...
  document.getElementById("pd").innerHTML = dzone.length
    ...
    : `<p>To Physical Geographiers: The base map is a Scottish Index of Multiple Deprivation(SIMD)  map of Edinburgh. Try to use the mouse to hover over the first two layers and single click the green icons to auto-zoom to the point in the third map(Vehicle flow counting points). Summarize what did you find out? </p>`;
