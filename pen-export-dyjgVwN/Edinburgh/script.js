...
map.addControl(
 ...
 map.on("mousemove", (event) => {
  ...
  document.getElementById("pd").innerHTML = dzone.length
    ...
    : `<p>The base map is a Scottish Index of Multiple Deprivation(SIMD)  map of Edinburgh. Try to use the mouse to hover over the two layers and click the green icons in the third map(Vehicle flow counting points). Summarize what did you find out?</p>`;
